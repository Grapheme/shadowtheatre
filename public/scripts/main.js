...
function drawpath( canvas, pathstr, duration, attr, callback )
{
    ...
    .onAnimation(function () {
    	...
    	this.attr("transform", "t" + [point.x, point.y]);
    });
	...
	ellipse.attr({along: 0});
	ellipse.animate({along: 1}, 15000, function () {});
